...
const AddIncome: React.FC<AddIncomeProps> = ({ settings, wealthItems, onAdd, onCancel }) => {
      ...
      <div className="bg-brand-surface w-full max-w-sm rounded-[24px] shadow-2xl flex flex-col border border-brand-border overflow-hidden animate-slide-up">
        <div className="flex justify-between items-center px-4 py-2.5 border-b border-brand-border shrink-0">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-[9px] font-black uppercase tracking-widest text-brand-text">Add Income</h3>
          </div>
        ...
        <div className="p-4 space-y-3">
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                <select value={type} onChange={(e) => setType(e.target.value as IncomeType)} className={selectClasses}>
          ...
          <div className="space-y-1">
            ...
            <div className="relative">
              <select value={targetAccountId} onChange={(e) => setTargetAccountId(e.target.value)} className={selectClasses}>
          ...
          <div className="space-y-1">
            ...
            <input type="text" value={note} onChange={(e) => setNote(e.target.value)} placeholder="Reference..." className={selectClasses} />
          </div>

          <button 
            onClick={handleSubmit} 
            disabled={!amount}
            className="w-full py-3 bg-emerald-600 text-white font-black rounded-xl shadow-lg active:scale-[0.98] transition-all flex items-center justify-center gap-2 uppercase tracking-widest text-[10px] disabled:opacity-50 mt-1"
          >
